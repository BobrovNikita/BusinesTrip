...
{
    public partial class TypesTravelExpensesView : Form, ITypeTravelExpensesView
    {
        ...
        public int Rate
        {
            get
            {
                if (!int.TryParse(RateTxt.Text, out _))
                {
                    return 0;
                }
                else
                {
                    return int.Parse(RateTxt.Text);
                }
            }
            set
            {
        ...
        public TypesTravelExpensesView()
        {
            InitializeComponent();
        ...
        private static TypesTravelExpensesView? instance;

        public static TypesTravelExpensesView GetInstance(Form parentContainer)
        {
            if (instance == null || instance.IsDisposed)
            {
                ...
                instance = new TypesTravelExpensesView();
