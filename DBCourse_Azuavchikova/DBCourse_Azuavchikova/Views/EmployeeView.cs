...
namespace DBCourse_Azuavchikova.MVC.Views
{
    public partial class EmployeeView : Form, IEmployeeView
    {
        ...
        {
            get => (Position)PositionCmb.SelectedItem;
            set => PositionCmb.SelectedItem = value;
        }
        ...
        {
            PositionCmb.DataSource = source;
            PositionCmb.DisplayMember = "Name";
            PositionCmb.ValueMember = "Id";
        }
